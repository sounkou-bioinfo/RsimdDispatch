...
prefixes. It does not add a runtime dependency on `RsimdDispatch`. Replace the demo `count_nonzero()` and `convolve3()` kernels under `tools/kernels/` with your own
...
The same runtime switch can benchmark a numeric three-tap convolution/FIR kernel.
