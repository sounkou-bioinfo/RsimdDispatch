...
SD_DEFINE_RAW_COUNT_THUNK(sd_count_nonzero_avx512_invoke, sd_count_nonzero_avx512)
SD_DEFINE_F64_CONVOLVE_THUNK(sd_convolve1d_avx512_invoke, sd_convolve1d_avx512)

SD_KERNEL_TABLE_BEGIN(avx512)
    SD_KERNEL(COUNT_NONZERO, RAW_COUNT,    sd_count_nonzero_avx512_invoke),
    SD_KERNEL(CONVOLVE1D,    F64_CONVOLVE, sd_convolve1d_avx512_invoke),
SD_KERNEL_TABLE_END;
